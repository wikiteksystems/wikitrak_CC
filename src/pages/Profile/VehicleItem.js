...
const VehicleItem = ({ vehicle }) => {
    ...
    return (
        <div className='w-full h-full flex md:flex-row flex-col items-center justify-bewteen p-3' style={{border: '1px solid' + themeColor, borderRadius: 10}}>
            ...
            {/* <CarOutlined /> */}
                { picture === null ?
                <CarOutlined size={120} style={{background: ThemeColor.light_color_2, fontSize: 60, color:"white", padding:"20px", borderRadius:"50%"}}> { registration_id[0].toUpperCase() } </CarOutlined>
                :
