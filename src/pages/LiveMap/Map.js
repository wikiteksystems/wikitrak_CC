...
//   // console.log(gtVehi, "gtLocation map component1212")
...
//     return apiData?.imeiList?.includes(vehicle.imei[0].mac_id);
//   });
// console.log(vehicleList,"vehicleList............")
// console.log(apiData,"imeiList............")
...
// },[apiData,vehicleList])
// // useEffect(()=>{
// //   // console.log(activeDevices,"activeDevicesactiveDevices")
// // },[activeDevices,])
...
function Map({ locationData, vehicleGroupList, vehicleList, gtVehi, wikitekVehi, gtLocation, center, setCenter, activeParametersList }) {
  ...
  useEffect(() => {
    ...
    if (locationData && locationData.length > 0 && activeDevices && activeDevices.length > 0) {
      const activeImeis = activeDevices.map(device => device.imei && device.imei[0] && device.imei[0].mac_id);
    ...
    <>
      <div style={{ position: 'relative' }}>
        ...
        >
          ...
          {
            (id === "onlineVehicles" && filterd_activeVehi?.length > 0) &&
          ...
          {
            (id === "offlineVehicles" && filterd_in_activeVehi?.length > 0) &&
          ...
          {
            (id === "runningVeh" && runningVehicleList?.length > 0) &&
          ...
          {
            (id === "stopVeh" && stopVehicleList?.length > 0) &&
          ...
          {
            (id !== "onlineVehicles" && id !== "offlineVehicles" && id !=="runningVeh" && id !=="stopVeh") && (
              <>
                {gtVehi?.length > 0 && gtVehi.map((item, index) => (
                  <Marker
                    key={index}
                    ...
                    animation="BOUNCE"
                    icon={{
                      path: startblinking() &&"M8.5.5a.5.5 0 0 0-1 0v.518A7 7 0 0 0 1.018 7.5H.5a.5.5 0 0 0 0 1h.518A7 7 0 0 0 7.5 14.982v.518a.5.5 0 0 0 1 0v-.518A7 7 0 0 0 14.982 8.5h.518a.5.5 0 0 0 0-1h-.518A7 7 0 0 0 8.5 1.018zm-6.48 7A6 6 0 0 1 7.5 2.02v.48a.5.5 0 0 0 1 0v-.48a6 6 0 0 1 5.48 5.48h-.48a.5.5 0 0 0 0 1h.48a6 6 0 0 1-5.48 5.48v-.48a.5.5 0 0 0-1 0v.48A6 6 0 0 1 2.02 8.5h.48a.5.5 0 0 0 0-1zM8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4",
                      fillColor: apiData?.imeiList.includes(parseFloat(item.latestDocument.imei)) ? "red" : "grey",
                      fillOpacity: 2,
                      strokeWeight: 1,
                      rotation: item?.latestDocument?.heading,
