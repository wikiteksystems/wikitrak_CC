            ...
            <>
                ...
                <>
                    <div className="flex justify-between items-center" style={{background: matchColor(themeColor)}}>
                        <LeftCircleOutlined className='px-1' style={{fontSize: 20, color:"white", marginTop: 2}} onClick={ () => history.goBack() } />
                        <Header title={'Vehicle Parameter'} style={{paddingInline: 0, margin: 0, fontSize: 16 }} />
