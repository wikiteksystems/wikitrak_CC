        ...
        >
            ...
            <>
                ...
                <>
                    ...
                    { Vehi ? (<Button className=" flex gap-5 text-white" style={{margin:'20px auto 0 27px', padding:'0 91px 0 10px', background:"#0F4C75", color:"white"}}  onClick={() => {
                        setVehiDetail(!Vehi)
                        console.log(Vehi)
                    }}>
                        <ToggleOnIcon />
                        <span className="ps-2">Features</span></Button>)
                    : (<Button className=" flex gap-5 text-white" style={{margin:'20px auto 0 27px', padding:'0 91px 0 10px', background:"#0F4C75", color:"white"}}   onClick={() => {
                        setVehiDetail(!Vehi)
                        console.log(Vehi)
                    }}>
                        <ToggleOffIcon />
