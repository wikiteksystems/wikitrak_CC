import{cf as E,cg as T,b as D,c2 as F,e as U,f as M,j as h,_ as d,g as R,o as j,ch as z,bB as G,ce as K,l as W,cc as I,p as k,v as f,cd as w,q,k as H}from"./index-D0FmrQMl.js";const L=["className","component"];function V(e={}){const{themeId:r,defaultTheme:s,defaultClassName:t="MuiBox-root",generateClassName:c}=e,u=E("div",{shouldForwardProp:a=>a!=="theme"&&a!=="sx"&&a!=="as"})(T);return D.forwardRef(function(g,n){const i=F(s),m=U(g),{className:v,component:l="div"}=m,x=M(m,L);return h.jsx(u,d({as:l,ref:n,className:R(v,c?c(t):t),theme:r&&i[r]||i},x))})}const Z=j("MuiBox",["root"]),A=Z,J=z(),O=V({themeId:G,defaultTheme:J,defaultClassName:A.root,generateClassName:K.generate}),ce=O;function Q(e){return W("MuiCircularProgress",e)}j("MuiCircularProgress",["root","determinate","indeterminate","colorPrimary","colorSecondary","svg","circle","circleDeterminate","circleIndeterminate","circleDisableShrink"]);const X=["className","color","disableShrink","size","style","thickness","value","variant"];let p=e=>e,$,N,B,_;const o=44,Y=I($||($=p`
  0% {
...
`)),re=e=>{const{classes:r,variant:s,color:t,disableShrink:c}=e,u={root:["root",s,`color${f(t)}`],svg:["svg"],circle:["circle",`circle${f(s)}`,c&&"circleDisableShrink"]};return H(u,Q,r)},se=k("span",{name:"MuiCircularProgress",slot:"Root",overridesResolver:(e,r)=>{const{ownerState:s}=e;return[r.root,r[s.variant],r[`color${f(s.color)}`]]}})(({ownerState:e,theme:r})=>d({display:"inline-block"},e.variant==="determinate"&&{transition:r.transitions.create("transform")},e.color!=="inherit"&&{color:(r.vars||r).palette[e.color].main}),({ownerState:e})=>e.variant==="indeterminate"&&w(B||(B=p`
    ...
    `),ee)),oe=D.forwardRef(function(r,s){const t=q({props:r,name:"MuiCircularProgress"}),{className:c,color:u="primary",disableShrink:y=!1,size:a=40,style:g,thickness:n=3.6,value:i=0,variant:m="indeterminate"}=t,v=M(t,X),l=d({},t,{color:u,disableShrink:y,size:a,thickness:n,value:i,variant:m}),x=re(l),C={},P={},b={};if(m==="determinate"){const S=2*Math.PI*((o-n)/2);C.strokeDasharray=S.toFixed(3),b["aria-valuenow"]=Math.round(i),C.strokeDashoffset=`${((100-i)/100*S).toFixed(3)}px`,P.transform="rotate(-90deg)"}return h.jsx(se,d({className:R(x.root,c),style:d({width:a,height:a},P,g),ownerState:l,ref:s,role:"progressbar"},b,v,{children:h.jsx(te,{className:x.svg,ownerState:l,viewBox:`${o/2} ${o/2} ${o} ${o}`,children:h.jsx(ae,{className:x.circle,style:C,ownerState:l,cx:o,cy:o,r:(o-n)/2,fill:"none",strokeWidth:n})})}))}),ne=oe;export{ce as B,ne as C};
