...
`)),ve=v("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(e,t)=>{const{ownerState:r}=e;return[t.root,t[r.variant],r.animation!==!1&&t[r.animation],r.hasChildren&&t.withChildren,r.hasChildren&&!r.width&&t.fitContent,r.hasChildren&&!r.height&&t.heightAuto]}})(({theme:e,ownerState:t})=>{const r=ee(e.shape.borderRadius)||"px",a=te(e.shape.borderRadius);return o({display:"block",backgroundColor:e.vars?e.vars.palette.Skeleton.bg:Z(e.palette.text.primary,e.palette.mode==="light"?.11:.13),height:"1.2em"},t.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${a}${r}/${Math.round(a/.6*10)/10}${r}`,"&:empty:before":{content:'"\\00a0"'}},t.variant==="circular"&&{borderRadius:"50%"},t.variant==="rounded"&&{borderRadius:(e.vars||e).shape.borderRadius},t.hasChildren&&{"& > *":{visibility:"hidden"}},t.hasChildren&&!t.width&&{maxWidth:"fit-content"},t.hasChildren&&!t.height&&{height:"auto"})},({ownerState:e})=>e.animation==="pulse"&&H(N||(N=y`
    ...
    `),fe,(t.vars||t).palette.action.hover)),be=$.forwardRef(function(t,r){const a=U({props:t,name:"MuiSkeleton"}),{animation:n="pulse",className:i,component:l="span",height:c,style:p,variant:C="text",width:w}=a,b=E(a,ue),x=o({},a,{animation:n,component:l,variant:C,hasChildren:!!b.children}),j=me(x);return s.jsx(ve,o({as:l,ref:r,className:O(j.root,i),ownerState:x},b,{style:o({width:w,height:c},p)}))}),g=be;var k={},xe=X;Object.defineProperty(k,"__esModule",{value:!0});var W=k.default=void 0,ye=xe(V()),Ce=s;W=k.default=(0,ye.default)((0,Ce.jsx)("path",{d:"M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2m0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2"}),"MoreVert");function R(e){const{loading:t=!1}=e;return s.jsxs(K,{sx:{maxWidth:"75%",m:2,margin:"auto",padding:"50px"},children:[s.jsx(pe,{avatar:t&&s.jsx(g,{animation:"wave",variant:"circular",width:40,height:40}),action:t?null:s.jsx(G,{"aria-label":"settings",children:s.jsx(W,{})}),title:t?s.jsx(g,{animation:"wave",height:10,width:"80%",style:{marginBottom:6}}):"Loading...",subheader:t?s.jsx(g,{animation:"wave",height:10,width:"40%"}):"Loading, Please wait."}),s.jsx(J,{children:t?s.jsxs($.Fragment,{children:[s.jsx(g,{animation:"wave",height:10,style:{marginBottom:6}}),s.jsx(g,{animation:"wave",height:10,width:"80%"})]}):s.jsx(f,{variant:"body2",color:"text.secondary",component:"p",children:"Why First Minister of Scotland Nicola Sturgeon thinks GDP is the wrong measure of a country's success:"})})]})}R.propTypes={loading:q.bool};function _e(){return s.jsxs("div",{children:[s.jsx(R,{loading:!0}),s.jsx(R,{})]})}export{_e as default};
